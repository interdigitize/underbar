(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var rejected = _.filter(collection, function(el){
      if (!test(el)){
        return true;
      }
    });
  ...
  _.uniq = function(array) {
    ...
    return _.filter(sortedArr, function(arrayEl, index) {
      if(arrayEl !== sortedArr[index - 1]) {
        return true;
      }
    });
  };
  ...
  _.map = function(collection, iterator) {
    ...
    return 'If you want results, please give me an array.';
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < copiedArr.length; i++) {
      var temp = copiedArr[i];
      var switchIndex = randomIndexMaker();
      copiedArr[i] = copiedArr[switchIndex];
      copiedArr[switchIndex] = temp;
      console.log(i, copiedArr);
    }
